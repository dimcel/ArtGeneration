...
# ========================================
# PROMPT SETTINGS FOR 5 SEGMENTS - GOLDEN BROWN THEME
# ========================================

# 5 segments inspired by "Golden Brown" by The Stranglers
# Theme: mysterious, seductive, golden/amber aesthetic, 1980s elegance
segment_prompts = [
    # Segment 1: Introduction - Golden elegance
    "elegant woman in flowing golden dress, amber lighting, mysterious smile, 1980s aesthetic, sharp focus, cinematic",
    
    # Segment 2: Seductive movement
    "beautiful woman dancing slowly, golden brown hair flowing, warm amber light, seductive gaze, high detail, film grain",
    
    # Segment 3: Dark elegance
    "mysterious woman in shadows, golden highlights on face, dark elegant dress, dramatic lighting, sharp features, moody",
    
    # Segment 4: Hypnotic presence
    "enchanting woman with hypnotic eyes, golden brown tones, soft focus background, sharp portrait, ethereal beauty",
    
    # Segment 5: Final allure
    "captivating woman in golden light, flowing fabric, mysterious expression, warm amber glow, cinematic close-up, detailed"
]
...
print(f"\n🎨 Golden Brown Theme - Segment prompts:")
for i, prompt in enumerate(segment_prompts, 1):
    print(f"   Segment {i} ({(i-1)*3:.1f}-{i*3:.1f}s): {prompt[:70]}...")
...
print("\n📺 Expected result: 15-second video with Golden Brown theme - mysterious, elegant woman in golden/amber tones")